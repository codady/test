<#
Last modified: 2023-08-12 18:37:22
...
terser '.\dist\js\ax.js' -o '.\dist\js\ax.min.js' -c arguments,dead_code,directives,arrows -m keep_classnames=true,keep_fnames=true
