<#
Last modified: 2023-08-12 20:37:20
...
($time + (Get-Content '..\dist\js\ax.min.js')) | Set-Content '..\dist\js\ax.min.js'
($time + (Get-Content '..\dist\css\ax.min.css')) | Set-Content '..\dist\js\ax.min.js'
