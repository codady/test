<#
Last modified: 2023-08-12 14:15:10
...
#>
#Execute the rollup packaging command of ax.js, the build command is customizable, please check the rollup.config.js file
#执行ax.js的rollup打包命令，build命令是可自定义的，请查看rollup.config.js文件
& npm run build
